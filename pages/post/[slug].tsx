      ...
      <article className="max-w-3xl mx-auto p-5">
        ...
        <div className="flex items-center space-x-2">
          ...
          <p className="font-extralight text-sm">
            Blog post by{" "}
            <span className="text-indigo-500">{post.author.name}</span> -
        ...
        >
          ...
          <label className="block mb-5">
            ...
            <textarea
              ...
              className="shadow border rounded py-2 px-3 form-textarea block w-full ring-yellow-500 outline-none focus:ring ring-0"
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 60, // after 60 seconds, it will update the old cache within 60 seconds
  };
};
